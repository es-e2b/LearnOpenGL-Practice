...
// lighting
glm::vec3 lightPos(-0.3f, 1.0f, 2.0f);
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 ambientColor = diffuseColor * glm::vec3(0.1f); // low influenc
        ...
        // material properties
        sphereShader1.setVec3("material.ambient", 0.99f, 0.99f, 0.99f);
        sphereShader1.setVec3("material.diffuse", 0.9f, 0.9f, 0.9f);
        ...
        // light properties
        // glm::vec3 lightColor(1.0, 1.0, 1.0);;
        diffuseColor = lightColor * glm::vec3(0.9f); // decrease the influence
        ...
        sphereShader1.setVec3("light.position", lightPos);
        // material properties
        sphereShader1.setVec3("material.ambient", 0.5f, 0.7f, 0.5f);
        sphereShader1.setVec3("material.diffuse", 0.7f, 0.44f, 0.3f);
        sphereShader1.setVec3("material.specular", 0.5f, 0.5f, 0.5f); // specular lighting doesn't have full effect on this object's material
        ...
        sphereShader1.setVec3("light.position", lightPos);
        // material properties
        sphereShader1.setVec3("material.ambient", 0.7f, 0.0f, 0.0f);
        sphereShader1.setVec3("material.diffuse", 0.6f, 0.5f, 0.6f);
        sphereShader1.setVec3("material.specular", 0.5f, 0.5f, 0.5f); // specular lighting doesn't have full effect on this object's material
        sphereShader1.setFloat("material.shininess", 1.5f);
        // world transformation
        model = glm::mat4(1.0f);
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        model = glm::translate(model, glm::vec3(-2.0f, 0.0f, 0.0f));
        ...
        // light properties
        // glm::vec3 lightColor(1.0, 1.0, 1.0);;
        diffuseColor = lightColor * glm::vec3(0.99f); // decrease the influence
        ambientColor = diffuseColor * glm::vec3(0.5f); // low influenc
        sphereShader1.setVec3("light.ambient", ambientColor);
        sphereShader1.setVec3("light.diffuse", diffuseColor);
        sphereShader1.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
        sphereShader1.setVec3("light.position", lightPos);
        ...
        sphereShader1.setFloat("material.shininess", 50.0f);
        // world transformation
        model = glm::mat4(1.0f);
        model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        ...
        sphereShader1.setVec3("light.position", lightPos);
        // material properties
        sphereShader1.setVec3("material.ambient", 0.99f, 0.5f, 0.7f);
        sphereShader1.setVec3("material.diffuse", 0.3f, 0.5f, 0.9f);
